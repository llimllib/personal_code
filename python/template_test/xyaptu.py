...
__history__= {
  ...
  '1.0.1' : '2004/12/09: Modified by Bill Mill. Removed extra spaces in output at the cost of no expressions on same line as <py-open'
}
...
class xcopier(copier):
  ...
  def _x2y_translate(self, xStr):
    ...
    def ropen(match,self=self): 
      return '++yaptu %s ' % match.group(match.lastindex)
