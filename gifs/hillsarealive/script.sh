...
if [ ! -f out.mkv ]; then
    ...
    ffmpeg -ss 4 -i "$(youtube-dl -g "https://www.youtube.com/watch?v=5fH2FOn1V5g" | head -n1)" -t 8 -c copy out.mkv
fi

# https://ffmpeg.org/ffmpeg-filters.html#drawtext-1
ffmpeg -ss 4 -t 4 -i "out.mkv" -y -filter_complex "[0:v]
fps=12,
scale=640:-1,
...
drawtext='
    ...
    x=(main_w/2-text_w/2):
    y=320:
    text=some day my green checkmark will come'
" "hills.gif"
