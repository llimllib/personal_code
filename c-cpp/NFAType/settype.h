...
class SetType
{
	public:
		...
		// OUT: true if char was found, false otherwise
		bool is_member(char);
		...
		//  IN: SetType to search s for
		// OUT: true if all elements of the SetType are in S, false otherwise
		bool is_subset(SetType*);
		...
		// OUT: Returns the value of setSize
		int getSize();
		
    //  IN: int, the index of the set you would like to retrieve.
    // OUT: the character in s at the given index
    char getCharFromSet(int);
