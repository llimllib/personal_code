...
# General 
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="llimllib"
...
# macos_notification_count.sh 
    ...
    # sqlite3 $(find /var/folders -path '*notificationcenter*db2/db' 2>/dev/null) 'select * from app'
    # to list all apps into vim:
    # new | 0read !sqlite3 $(find /var/folders -path '*notificationcenter*db2/db' 2>/dev/null) 'select * from app'
	...
	export TMUX_POWERLINE_SEG_MACOS_NOTIFICATION_COUNT_APPIDS="1 2 73"
	# Notification symbol
...
# mailcount.sh 
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/llimllib/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/llimllib/.mailcheckrc"
